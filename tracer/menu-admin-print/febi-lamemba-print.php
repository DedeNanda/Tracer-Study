...
$gender = mysqli_query($con, "SELECT * FROM febi_lamemba where gender='Pria'");
$jumlah1 = mysqli_num_rows($gender);

$gender = mysqli_query($con, "SELECT * FROM febi_lamemba where gender='Wanita'");
$jumlah2 = mysqli_num_rows($gender);

$pertanyaan1 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan1='YA'");
$jumlah3 = mysqli_num_rows($pertanyaan1);

$pertanyaan1 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan1='TIDAK'");
$jumlah4 = mysqli_num_rows($pertanyaan1);

$pertanyaan2 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan2='YA'");
$jumlah5 = mysqli_num_rows($pertanyaan2);

$pertanyaan2 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan2='TIDAK'");
$jumlah6 = mysqli_num_rows($pertanyaan2);

$pertanyaan3 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan3='YA'");
$jumlah7 = mysqli_num_rows($pertanyaan3);

$pertanyaan3 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan3='TIDAK'");
$jumlah8 = mysqli_num_rows($pertanyaan3);

$pertanyaan4 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan4='SUDAH'");
$jumlah9 = mysqli_num_rows($pertanyaan4);

$pertanyaan4 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan4='BELUM'");
$jumlah10 = mysqli_num_rows($pertanyaan4);

$pertanyaan5 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan5='Bekerja'");
$jumlah11 = mysqli_num_rows($pertanyaan5);

$pertanyaan5 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan5='Wiraswasta'");
$jumlah12 = mysqli_num_rows($pertanyaan5);

$pertanyaan5 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan5='Melanjutkan Pendidikan'");
$jumlah13 = mysqli_num_rows($pertanyaan5);

$pertanyaan5 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan5='Tidak kerja tetapi sedang mencari kerja'");
$jumlah14 = mysqli_num_rows($pertanyaan5);

$pertanyaan5 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan5='Belum memungkinkan bekerja'");
$jumlah15 = mysqli_num_rows($pertanyaan5);

$pertanyaan5 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan5='Menikah/ wajib militer/ mengurus keluarga'");
$jumlah16 = mysqli_num_rows($pertanyaan5);

$pertanyaan6 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan6='SUDAH'");
$jumlah17 = mysqli_num_rows($pertanyaan6);

$pertanyaan6 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan6='BELUM'");
$jumlah18 = mysqli_num_rows($pertanyaan6);

$pertanyaan7 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan7='Kurang 3 Bulan'");
$jumlah19 = mysqli_num_rows($pertanyaan7);

$pertanyaan7 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan7='3 s/d 6 Bulan'");
$jumlah20 = mysqli_num_rows($pertanyaan7);

$pertanyaan7 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan7='6 s/d 1 Tahun'");
$jumlah21 = mysqli_num_rows($pertanyaan7);

$pertanyaan7 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan7='1 s/d 2 Tahun'");
$jumlah22 = mysqli_num_rows($pertanyaan7);

$pertanyaan7 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan7='Lebih Dari 2 Tahun'");
$jumlah23 = mysqli_num_rows($pertanyaan7);

$pertanyaan7 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan7='Belum bekerja'");
$jumlah24 = mysqli_num_rows($pertanyaan7);

$pertanyaan8 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan8='Lokal'");
$jumlah25 = mysqli_num_rows($pertanyaan8);

$pertanyaan8 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan8='Nasional'");
$jumlah26 = mysqli_num_rows($pertanyaan8);

$pertanyaan8 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan8='Internasional'");
$jumlah27 = mysqli_num_rows($pertanyaan8);

$pertanyaan8 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan8='Belum bekerja'");
$jumlah28 = mysqli_num_rows($pertanyaan8);

$pertanyaan9 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan9='1 s/d 2,5 JT'");
$jumlah29 = mysqli_num_rows($pertanyaan9);

$pertanyaan9 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan9='2,5 s/d 4,5 JT'");
$jumlah30 = mysqli_num_rows($pertanyaan9);

$pertanyaan9 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan9='lebih 5 JT'");
$jumlah31 = mysqli_num_rows($pertanyaan9);

$pertanyaan10 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan10='Lebih 86 %'");
$jumlah32 = mysqli_num_rows($pertanyaan10);

$pertanyaan10 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan10='76 % s/d 85 %'");
$jumlah33 = mysqli_num_rows($pertanyaan10);

$pertanyaan10 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan10='61 % s/d 75 %'");
$jumlah34 = mysqli_num_rows($pertanyaan10);

$pertanyaan10 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan10='51 % s/d 59 %'");
$jumlah35 = mysqli_num_rows($pertanyaan10);

$pertanyaan10 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan10='kurang 50 %'");
$jumlah36 = mysqli_num_rows($pertanyaan10);

$pertanyaan10 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan10='Belum bekerja'");
$jumlah37 = mysqli_num_rows($pertanyaan10);

$pertanyaan11 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan11='Relevan'");
$jumlah38 = mysqli_num_rows($pertanyaan11);

$pertanyaan11 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan11='Kurang Relevan'");
$jumlah39 = mysqli_num_rows($pertanyaan11);

$pertanyaan11 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan11='Tidak Relevan'");
$jumlah40 = mysqli_num_rows($pertanyaan11);

$pertanyaan12 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan12='Setingkat lebih tinggi'");
$jumlah41 = mysqli_num_rows($pertanyaan12);

$pertanyaan12 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan12='Tingkat yang sama'");
$jumlah42 = mysqli_num_rows($pertanyaan12);

$pertanyaan12 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan12='Setingkat lebih rendah'");
$jumlah43 = mysqli_num_rows($pertanyaan12);

$pertanyaan12 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan12='Tidak perlu pendidikan tinggi'");
$jumlah44 = mysqli_num_rows($pertanyaan12);

$pertanyaan13 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan13='Kurang 5'");
$jumlah45 = mysqli_num_rows($pertanyaan13);

$pertanyaan13 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan13='6 s/d 20'");
$jumlah46 = mysqli_num_rows($pertanyaan13);

$pertanyaan13 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan13='20 s/d 40'");
$jumlah47 = mysqli_num_rows($pertanyaan13);

$pertanyaan13 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan13='Lebih dari 40 '");
$jumlah48 = mysqli_num_rows($pertanyaan13);

$pertanyaan14 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan14='Kurang 5'");
$jumlah49 = mysqli_num_rows($pertanyaan14);

$pertanyaan14 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan14='6 s/d 20'");
$jumlah50 = mysqli_num_rows($pertanyaan14);

$pertanyaan14 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan14='20 s/d 40'");
$jumlah51 = mysqli_num_rows($pertanyaan14);

$pertanyaan14 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan14='Lebih dari 40 '");
$jumlah52 = mysqli_num_rows($pertanyaan14);

$pertanyaan15 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan15='Kurang 5'");
$jumlah53 = mysqli_num_rows($pertanyaan15);

$pertanyaan15 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan15='6 s/d 20'");
$jumlah54 = mysqli_num_rows($pertanyaan15);

$pertanyaan15 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan15='20 s/d 40'");
$jumlah55 = mysqli_num_rows($pertanyaan15);

$pertanyaan15 = mysqli_query($con, "SELECT * FROM febi_lamemba where pertanyaan15='Lebih dari 40 '");
...
<body>
        ...
        <div class="col-md-20">
            <div class="card">
                <div class="card-header">
                    <h4> Data Febi lamemba</h4>
                </div>
                <div class="card-header">
                    <h4>
                        <a href="../filter/filter_febi_lamemba.php" class="btn btn-warning float-end">Cari Data</a></td>
                        <a href="../menu-admin/febi-lamemba.php" class="btn btn-primary ">Back</a></td>
                    </h4>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                $query = "SELECT * FROM febi_lamemba";
