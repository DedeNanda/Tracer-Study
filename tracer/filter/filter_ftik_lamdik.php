...
<style type="text/css" media="print">
    ...
    <div class="container">
        <h2 align="center" style="margin: 30px;">Data FTIK LAMDIK UIN SMDD Bukittinggi</h2>
        <?php
        $s_jurusan = "";
        $tanggal = "";
        ...
        <form method="POST" action="">
            <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <select name="s_jurusan" id="s_jurusan" class="form-control ">
                            ...
                            <option value="PENDIDIKAN AGAMA ISLAM" <?php if ($s_jurusan == "PENDIDIKAN AGAMA ISLAM") {
                                                                        echo "selected";
                                                                    } ?>>PENDIDIKAN AGAMA ISLAM</option>
                            <option value="PENDIDIKAN BAHASA ARAB" <?php if ($s_jurusan == "PENDIDIKAN BAHASA ARAB") {
                                                                        echo "selected";
                                                                    } ?>>PENDIDIKAN BAHASA ARAB</option>
                            <option value="PENDIDIKAN BAHASA INGGRIS" <?php if ($s_jurusan == "PENDIDIKAN BAHASA INGGRIS") {
                                                                            echo "selected";
                                                                        } ?>>PENDIDIKAN BAHASA INGGRIS</option>
                            <option value="PENDIDIKAN MATEMATIKA" <?php if ($s_jurusan == "PENDIDIKAN MATEMATIKA") {
                                                                        echo "selected";
                                                                    } ?>>PENDIDIKAN MATEMATIKA</option>
                            <option value="PENDIDIKAN TEKNIK INFORMATIKA KOMPUTER" <?php if ($s_jurusan == "PENDIDIKAN TEKNIK INFORMATIKA KOMPUTER") {
                                                                                        echo "selected";
                                                                                    } ?>>PENDIDIKAN TEKNIK INFORMATIKA KOMPUTER</option>
                            <option value="BIMBINGAN KONSELING" <?php if ($s_jurusan == "BIMBINGAN KONSELING") {
                                                                    echo "selected";
                                                                } ?>>BIMBINGAN KONSELING</option>
                            <option value="PENDIDIKAN AGAMA ISLAM S2" <?php if ($s_jurusan == "PENDIDIKAN AGAMA ISLAM S2") {
                                                                            echo "selected";
                                                                        } ?>>PENDIDIKAN AGAMA ISLAM S2</option>
                            <option value="TADRIS BAHASA INGGRIS S2" <?php if ($s_jurusan == "TADRIS BAHASA INGGRIS S2") {
                                                                            echo "selected";
                                                                        } ?>>TADRIS BAHASA INGGRIS S2</option>
                            <option value="PENDIDIKAN AGAMA ISLAM S3" <?php if ($s_jurusan == "PENDIDIKAN AGAMA ISLAM S3") {
                                                                            echo "selected";
                                                                        } ?>>PENDIDIKAN AGAMA ISLAM S3</option>
                            <option value="PENDIDIKAN PROFESI GURU" <?php if ($s_jurusan == "PENDIDIKAN PROFESI GURU") {
                                                                        echo "selected";
                                                                    } ?>>PENDIDIKAN PROFESI GURU</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    ...
                    <a href="../menu-admin/ftik-lamdik.php" class="btn btn-warning" type="button">
                        <h7>Kembali</h7>
                    </a>
                </div>
            </div>
        ...
        <table class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                ...
                $no = 1;
                $query = "SELECT * FROM ftik_lamdik WHERE prodi LIKE ? AND (nim LIKE ? OR nama LIKE ? OR gender LIKE ? OR notelepon LIKE ?  OR email LIKE ? OR tanggal LIKE ?) ORDER BY id DESC";
