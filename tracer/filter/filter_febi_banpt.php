...
<style type="text/css" media="print">
    ...
    <div class="container">
        <h2 align="center" style="margin: 30px;">Data FEBI BANPT UIN SMDD Bukittinggi</h2>
        <?php
        $s_jurusan = "";
        $tanggal = "";
        ...
        <form method="POST" action="">
            <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <select name="s_jurusan" id="s_jurusan" class="form-control ">
                            ...
                            <option value="MANAJEMEN HAJI DAN UMRAH" <?php if ($s_jurusan == "MANAJEMEN HAJI DAN UMRAH") {
                                                                            echo "selected";
                                                                        } ?>>MANAJEMEN HAJI DAN UMRAH</option>
                            <option value="PARIWISATA SYARIAH" <?php if ($s_jurusan == "PARIWISATA SYARIAH") {
                                                                    echo "selected";
                                                                } ?>>PARIWISATA SYARIAH</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    ...
                    <a href="../menu-admin/febi-banpt.php" class="btn btn-warning" type="button">
                        <h7>Kembali</h7>
                    </a>
                </div>
            </div>
        ...
        <table class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                ...
                $no = 1;
                $query = "SELECT * FROM febi_banpt WHERE prodi LIKE ? AND (nim LIKE ? OR nama LIKE ? OR gender LIKE ? OR notelepon LIKE ?  OR email LIKE ? OR tanggal LIKE ?) ORDER BY id DESC";
