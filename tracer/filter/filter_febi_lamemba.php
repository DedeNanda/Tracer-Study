...
<body>
    ...
    <h2 align="center" style="margin: 30px;">Data FEBI LAMEMBA UIN SMDD Bukittinggi</h2>
    <?php
    $s_jurusan = "";
    $tanggal = "";
    ...
    <form method="POST" action="">
        <div class="row mb-3">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    <select name="s_jurusan" id="s_jurusan" class="form-control ">
                        ...
                        <option value="AKUTANSI SYARIAH" <?php if ($s_jurusan == "AKUTANSI SYARIAH") {
                                                                echo "selected";
                                                            } ?>>AKUTANSI SYARIAH</option>
                        <option value="EKONOMI ISLAM" <?php if ($s_jurusan == "EKONOMI ISLAM") {
                                                            echo "selected";
                                                        } ?>>EKONOMI ISLAM</option>
                        <option value="BISNIS DIGITAL" <?php if ($s_jurusan == "BISNIS DIGITAL") {
                                                            echo "selected";
                                                        } ?>>BISNIS DIGITAL</option>
                        <option value="MANAJEMEN BISNIS SYARIAH" <?php if ($s_jurusan == "MANAJEMEN BISNIS SYARIAH") {
                                                                        echo "selected";
                                                                    } ?>>MANAJEMEN BISNIS SYARIAH</option>
                        <option value="PERBANKKAN SYARIAH" <?php if ($s_jurusan == "PERBANKKAN SYARIAH") {
                                                                echo "selected";
                                                            } ?>>PERBANKKAN SYARIAH</option>
                        <option value="EKONOMI SYARIAH S2" <?php if ($s_jurusan == "EKONOMI SYARIAH S2") {
                                                                echo "selected";
            ...
            <div class="col-sm-4">
                ...
                <a href="../menu-admin/febi-lamemba.php" class="btn btn-warning" type="button">
                    <h7>Kembali</h7>
                </a>
            </div>
        </div>
    ...
    <table class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            $no = 1;
            $query = "SELECT * FROM febi_lamemba WHERE prodi LIKE ? AND (nim LIKE ? OR nama LIKE ? OR gender LIKE ? OR notelepon LIKE ?  OR email LIKE ? OR tanggal LIKE ?) ORDER BY id DESC";
