...
<body>
    ...
    <div class="container">
        <h2 align="center" style="margin: 30px;">Data SYARIAH BANPT UIN SMDD Bukittinggi</h2>
        <?php
        $s_jurusan = "";
        $tanggal = "";
        ...
        <form method="POST" action="">
            <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <select name="s_jurusan" id="s_jurusan" class="form-control ">
                            ...
                            <option value="HUKUM KELUARGA ISLAM" <?php if ($s_jurusan == "HUKUM KELUARGA ISLAM") {
                                                                        echo "selected";
                                                                    } ?>>HUKUM KELUARGA ISLAM</option>
                            <option value="HUKUM EKONOMI SYARIAH" <?php if ($s_jurusan == "HUKUM EKONOMI SYARIAH") {
                                                                        echo "selected";
                                                                    } ?>>HUKUM EKONOMI SYARIAH</option>
                            <option value="HUKUM TATANEGARA" <?php if ($s_jurusan == "HUKUM TATANEGARA") {
                                                                    echo "selected";
                                                                } ?>>HUKUM TATANEGARA</option>
                            <option value="HUKUM PIDANA ISLAM" <?php if ($s_jurusan == "HUKUM PIDANA ISLAM") {
                                                                    echo "selected";
                                                                } ?>>HUKUM PIDANA ISLAM</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    ...
                    <a href="../menu-admin/syariah-banpt.php" class="btn btn-warning" type="button">
                        <h7>Kembali</h7>
                    </a>
                </div>
            </div>
        ...
        <table class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                ...
                $no = 1;
                $query = "SELECT * FROM syariah_banpt WHERE prodi LIKE ? AND (nim LIKE ? OR nama LIKE ? OR gender LIKE ? OR notelepon LIKE ?  OR email LIKE ? OR tanggal LIKE ?) ORDER BY id DESC";
