    ...
    <div class="container" <div class="row">
        <div class="col-md-20">
            <div class="card">
                ...
                <div class="card-header">
                    <h4>
                        <a href="../diagram/ftik-lamsama.php" class="btn btn-success">Diagram yang sudah mengisi</a></td>
                        <a href="../filter/filter_ftik_lamsama.php" class="btn btn-warning float-end">Cari Data</a></td>
                        <a href="../menu-admin-print/ftik-lamsama-print.php" class="btn btn-info">Print</a>
                    </h4>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered table-striped" style="margin-left:5px;;margin-right:5px;">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <p><a href="ftik-view-lamsama.php?id=<?= $student['id']; ?>" class="btn btn-info btn-sm">View</a>
                            <p><a href="ftik-edit-lamsama.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                            <form action="../kusioner/code-ftik-lamsama.php" method="POST" class="d-inline">
