                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM ftik_lamdik WHERE id='$student_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="../kusioner/code-ftik-lamdik.php" method="POST">
                                ...
                                <label>Prodi</label>
                                    <select name="prodi" class="form-control">
                                        ...
                                        <option value="PENDIDIKAN TEKNIK INFORMATIKA KOMPUTER">PENDIDIKAN TEKNIK INFORMATIKA KOMPUTER</option>
                                        <option value="BIMBINGAN KONSELING">BIMBINGAN KONSELING</option>
                                        <option value="PENDIDIKAN AGAMA ISLAM S2">PENDIDIKAN AGAMA ISLAM S2</option>
                                        <option value="TADRIS BAHASA INGGRIS S2">TADRIS BAHASA INGGRIS S2</option>
                                        <option value="PENDIDIKAN AGAMA ISLAM S3">PENDIDIKAN AGAMA ISLAM S3</option>
                  ...
                            </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="pertanyaan11" value="<?=$student['pertanyaan12'];?>" class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
