                    ...
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="../kusioner/code-fuad-banpt.php" method="POST">
                                ...
                                <label>Prodi</label>
                                    <select name="prodi" class="form-control">
                                        <option value="ILMU ALQURAN DAN TAFSIR">ILMU ALQURAN DAN TAFSIR</option>
                                        ...
                                        <option value="AQIDAH DAN FILSAFAT ISLAM">AQIDAH DAN FILSAFAT ISLAM</option>
