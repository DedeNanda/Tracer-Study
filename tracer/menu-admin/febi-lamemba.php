...
<body>
    ...
    <div class="container" <div class="row">
        <div class="card">
            ...
            <div class="card-header">
                <h4>
                    <a href="../filter/filter_febi_lamemba.php" class="btn btn-warning float-end">Cari Data</a>
                    <a href="../diagram/febi-lamemba.php" class="btn btn-success">Diagram yang sudah mengisi</a>
                    <a href="../menu-admin-print/febi-lamemba-print.php" class="btn btn-info">Print</a>
                </h4>
            </div>
        </div>
    </div>
            ...
            <table class="table table-bordered table-striped" style="margin-left:5px;;margin-right:5px;">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <p><a href="febi-view-lamemba.php?id=<?= $student['id']; ?>" class="btn btn-info btn-sm">View</a>
                            <p><a href="febi-edit-lamemba.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                            <form action="../kusioner/code-febi-lamemba.php" method="POST" class="d-inline">
