                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM pascasarjana WHERE id='$student_id' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="../kusioner/code-pascasarjana.php" method="POST">
