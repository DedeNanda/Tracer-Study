            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Kusioner ftik lamdik
                            <a href="../kusioner/kusioner-index3.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="code-ftik-lamdik.php" method="POST">
                            <div class="mb-3">
