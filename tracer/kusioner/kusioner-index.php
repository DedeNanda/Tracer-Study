                ...
                <div class="right-content-home">
                    <div class="d-grid gap-2 col-6 mx-auto">
                        <h2>Fakultas Ekonomi dan Bisnis Islam</h2>
                            <a href="../kusioner/kusioner-index2.php" class="btn btn-success" type="button"><h3>FEBI</h3></a></button>
                        <h2>Fakultas Tarbiyah dan Ilmu Keguruan</h2>
                            <a href="../kusioner/kusioner-index3.php" class="btn btn-success" type="button"><h3>FTIK</h3></a></button>
                        <h2>Fakultas Ushuludin Adab dan Dakwah</h2>
                            <a href="../kusioner/kusioner-fuad-banpt.php" class="btn btn-success" type="button"><h3>FUAD</h3></a></button>
                        <h2>PASCASARJANA</h2>
                            <a href="../kusioner/kusioner-pascasarjana.php" class="btn btn-success" type="button"><h3>PASCASARJANA</h3></a></button>
                        <h2>Syariah</h2>
                            <a href="../kusioner/kusioner-syariah-banpt.php" class="btn btn-success" type="button"><h3>SYARIAH</h3></a></button>
                    </div>     
                </div>
            </div>
        </div>
