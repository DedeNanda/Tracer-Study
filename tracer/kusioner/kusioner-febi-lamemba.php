            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Kusioner FEBI lamemba
                            <a href="../kusioner/kusioner-index2.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="code-febi-lamemba.php" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label>Prodi</label>
                                    <select name="prodi" class="form-control">
                                            <option value="AKUTANSI SYARIAH">AKUTANSI SYARIAH</option>
                                            ...
                                            <option value="PERBANKKAN SYARIAH">PERBANKKAN SYARIAH</option>
