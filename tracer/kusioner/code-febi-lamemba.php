...
if(isset($_POST['delete_student']))
{
    ...
    $query = "DELETE FROM febi_lamemba WHERE id='$student_id' ";
    $query_run = mysqli_query($con, $query);

    if($query_run)
    {
        $_SESSION['message'] = "Deleted Successfully";
        header("Location: ../menu-admin/febi-lamemba.php");
        exit(0);
    }
    else
    {
