...
if(isset($_POST['delete_student']))
{
    ...
    $query = "DELETE FROM ftik_laminfokom WHERE id='$student_id' ";
    $query_run = mysqli_query($con, $query);

    if($query_run)
    {
        $_SESSION['message'] = "Deleted Successfully";
        header("Location: ../menu-admin/ftik-laminfokom.php");
        exit(0);
    }
    else
    {
